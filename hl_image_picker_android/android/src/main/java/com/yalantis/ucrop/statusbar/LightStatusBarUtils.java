...
public class LightStatusBarUtils {
    ...
    private static void setMIUILightStatusBar(Activity activity, boolean isMarginStatusBar
    ...
    private static void setFlymeLightStatusBar(Activity activity, boolean isMarginStatusBar
            , boolean isMarginNavigationBar, boolean isTransStatusBar, boolean dark) {
        ...
        if (activity != null) {
            ...
            try {
                ...
                @SuppressLint("PrivateApi") Field darkFlag = WindowManager.LayoutParams.class
                        .getDeclaredField("MEIZU_FLAG_DARK_STATUS_BAR_ICON");
                //noinspection JavaReflectionMemberAccess
                @SuppressLint("PrivateApi") Field meizuFlags = WindowManager.LayoutParams.class
